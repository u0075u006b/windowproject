...
class LeftItem(QListWidget):
    def __init__(self,btname,listname):
        ...
        self.btn = QPushButton(self.btname)
        self.btn.setFixedHeight(23)
    ...
    def resizeEvent(self, event):
        # 解决item的高度问题
        super(LeftItem, self).resizeEvent(event)
        self.setSizeHint(QSize(self.minimumWidth(), self.height()))
